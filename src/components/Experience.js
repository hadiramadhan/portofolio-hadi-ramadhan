    ...
    <div className='my-64'> 
        ...
        '/>
            ...
            <ul className='w-full flex flex-col items-start justify-between ml-4 xs:ml-2'>
                ...
                time="2018"
                addres="Jalan Dewi Sartika No 121"
                work="Memproses sebuah barang"
                />
                <Details
                position="Duty Officer"
                company="BCA (Bank Central Asia)"
                companyLink="https://www.bca.co.id/"
                time="2020-2023"
                addres="Jalan Panglima Polim"
                work="Membantu Nasabah Transaksi"
                />
                <Details
                position="Helper cook"
                company="Eaton Restaurant"
                companyLink="https://www.eatonindonesia.com/id/"
                time="2017"
                addres="Jalan Dewi Sartika No 121"
                work="Membantu Membuat Sebuah Masakan"
                />
            </ul>
        </div>
    </div>
