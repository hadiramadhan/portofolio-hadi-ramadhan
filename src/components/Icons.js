...
export const WhatsappIcon = ({ className, ...rest }) => (
  ...
  >
    {
      <path d="M21.2 2H2.8C1.46957 2 0.411932 3.05763 0.411932 4.38807L0.4 21.6119C0.4 22.9424 1.46957 24 2.8 24L12 23.9999L21.2 24C22.5304 24 23.6 22.9424 23.6 21.6119V4.38807C23.6 3.05763 22.5304 2 21.2 2ZM12 23.9999V21.8182C12 21.5706 12.0792 21.3308 12.2071 21.1337C12.3351 20.9366 12.5 20.7933 12.7 20.7435C13.1 20.646 18.3 19.1004 18.3 13.5C18.3 12.447 18.136 11.403 17.8247 10.4247C17.5888 9.74073 17.1649 9.16344 16.6504 8.77751C16.1359 8.39159 15.5561 8.21965 14.9717 8.29053C14.3874 8.3614 13.8375 8.66993 13.4127 9.14488C12.9796 9.62401 12.7 10.2287 12.6 10.875C12.6 11.9819 12.7 13.1434 12.7 13.5C12.7 14.2661 12.6469 17.5801 12.7 17.75" />
    }
  </svg>
);
