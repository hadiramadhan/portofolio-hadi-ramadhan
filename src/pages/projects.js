            ...
            <Layout classname='pt-16'>
                ...
                <div className='grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0'>
                    <div className='col-span-12'>
                       <FeaturedProject
                       title="Project Landing Page Tailwind CSS"
                       img={project1}
                       link= 
                       'https://landing-page-tailwind-css-54c9.vercel.app/'
                    ...
                    <Project
                       title="Project Undangan Pernikahan Menggunakan Boostrap"
                       img={project2}
                       link= 
                       'https://undangan-wedding-amber.vercel.app/'
                       github="https://github.com/HadiRamadhan"
                       type="Project 2"
                       />
                    </div>
                    <div className='col-span-6 sm:col-span-12'>
                    <Project
                       title="Project Landing Page Bootstrap"
                       img={project3}
                       link= 
                       'https://landing-page-bootstrap-alpha.vercel.app/'
                       github="https://github.com/HadiRamadhan"
                       type="Project 2"
                       />
                    </div>
                    <div className='col-span-12 p-2'>
                       <FeaturedProject
                       title="Project Landing Page UMKM "
                       img={project4}
                       link= 
                       'https://landing-page-umkm.vercel.app/'
                       github="https://github.com/HadiRamadhan"
                       type="Project 4"
                       />
                    </div>
